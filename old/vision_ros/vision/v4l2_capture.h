...
#define WEBCAM_FILE	"data/vision/vision_webcam.txt"
//==========================================================================
///
...
//------------------------------------------------------------------------------
///
///	Esegue le istruzioni necessarie al processamento dell'immagine con i marker a sfera
/// 
//------------------------------------------------------------------------------

inline void camera_processing();

inline void camera_processing_laser();
