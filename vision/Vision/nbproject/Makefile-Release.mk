...
${OBJECTDIR}/_ext/1472/v4l2_capture.o: ../v4l2_capture.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/v4l2_capture.o ../v4l2_capture.c

${OBJECTDIR}/_ext/1472/labelling.o: ../labelling.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/labelling.o ../labelling.c

${OBJECTDIR}/_ext/1472/log.o: ../log.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/log.o ../log.c

${OBJECTDIR}/_ext/1472/lists.o: ../lists.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/lists.o ../lists.c

${OBJECTDIR}/_ext/1472/couples.o: ../couples.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/couples.o ../couples.c

${OBJECTDIR}/_ext/1472/coordinates.o: ../coordinates.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/coordinates.o ../coordinates.c

${OBJECTDIR}/_ext/1472/simple_image.o: ../simple_image.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/simple_image.o ../simple_image.c

${OBJECTDIR}/_ext/1472/frame.o: ../frame.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/frame.o ../frame.c
