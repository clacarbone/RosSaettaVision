...
//   Defines
//===============
#define COLOR_FILE	"data/vision/vision_color.txt"
...
#define dtCrmin(codColor) colorStruct->dtColorYCbCr[(codColor-1)*6+2]
#define dtCrmax(codColor) colorStruct->dtColorYCbCr[(codColor-1)*6+3]
#define dtCbmin(codColor) colorStruct->dtColorYCbCr[(codColor-1)*6+4]
#define dtCbmax(codColor) colorStruct->dtColorYCbCr[(codColor-1)*6+5]
*/
/// Macro per la conversione da codice colore a posizione vettore YCbCr
#define dtYmin(codColor) colorStruct->dtColorYCbCr[(codColor-1)*6]
#define dtYmax(codColor) colorStruct->dtColorYCbCr[(codColor-1)*6+1]
...
FILE *soglie;
#define FILE_SOGLIE "vision_soglie.txt"
